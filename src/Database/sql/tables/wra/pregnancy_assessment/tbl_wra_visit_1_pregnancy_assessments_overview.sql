DROP TABLE IF EXISTS arch_etl_db.crt_wra_visit_1_pregnancy_assessments_overview;
CREATE TABLE arch_etl_db.crt_wra_visit_1_pregnancy_assessments_overview
(
...
CREATE UNIQUE INDEX pa_1_record_id_idx ON arch_etl_db.crt_wra_visit_1_pregnancy_assessments_overview (record_id);
...
CREATE INDEX pa_1_zapps_referral_outcome_idx ON arch_etl_db.crt_wra_visit_1_pregnancy_assessments_overview (zapps_referral_outcome);
CREATE INDEX pa_1_preferred_zapps_clinic_idx ON arch_etl_db.crt_wra_visit_1_pregnancy_assessments_overview (preferred_zapps_clinic);
CREATE INDEX pa_1_pregnancy_identifier_idx ON arch_etl_db.crt_wra_visit_1_pregnancy_assessments_overview (pregnancy_identifier);
CREATE FULLTEXT INDEX pa_1_ft_idx ON arch_etl_db.crt_wra_visit_1_pregnancy_assessments_overview (planned_place_for_birth,
