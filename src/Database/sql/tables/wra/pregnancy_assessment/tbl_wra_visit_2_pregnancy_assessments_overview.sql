DROP TABLE IF EXISTS arch_etl_db.crt_wra_visit_2_pregnancy_assessments_overview;
CREATE TABLE arch_etl_db.crt_wra_visit_2_pregnancy_assessments_overview
(
...
CREATE UNIQUE INDEX pa_2_record_id_idx ON arch_etl_db.crt_wra_visit_2_pregnancy_assessments_overview (record_id);
...
CREATE INDEX pa_2_pregnancy_identified_by_arch_idx ON arch_etl_db.crt_wra_visit_2_pregnancy_assessments_overview (pregnancy_identified_by_arch);
CREATE INDEX pa_2_pregnancy_has_antenatal_care_idx ON arch_etl_db.crt_wra_visit_2_pregnancy_assessments_overview (pregnancy_has_antenatal_care);
CREATE INDEX pa_2_anc_attendance_plan_idx ON arch_etl_db.crt_wra_visit_2_pregnancy_assessments_overview (anc_attendance_plan);
CREATE INDEX pa_2_zapps_enrollment_status_idx ON arch_etl_db.crt_wra_visit_2_pregnancy_assessments_overview (zapps_enrollment_status);
CREATE INDEX pa_2_zapps_referral_outcome_idx ON arch_etl_db.crt_wra_visit_2_pregnancy_assessments_overview (zapps_referral_outcome);
CREATE INDEX pa_2_preferred_zapps_clinic_idx ON arch_etl_db.crt_wra_visit_2_pregnancy_assessments_overview (preferred_zapps_clinic);
CREATE INDEX pa_2_pregnancy_identifier_idx ON arch_etl_db.crt_wra_visit_2_pregnancy_assessments_overview (pregnancy_identifier);
CREATE FULLTEXT INDEX pa_2_ft_idx ON arch_etl_db.crt_wra_visit_2_pregnancy_assessments_overview (planned_place_for_birth,
