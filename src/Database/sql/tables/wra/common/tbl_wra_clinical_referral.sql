...
CREATE INDEX c_ref_referral_id_idx ON arch_etl_db.crt_wra_clinical_referral_overview (referral_id);
CREATE INDEX c_ref_wra_ptid_idx ON arch_etl_db.crt_wra_clinical_referral_overview (wra_ptid);
CREATE INDEX c_ref_referral_destination_idx ON arch_etl_db.crt_wra_clinical_referral_overview (referral_destination);
