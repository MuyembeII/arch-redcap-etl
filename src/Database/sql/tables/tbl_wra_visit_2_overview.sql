...
FROM (SELECT fu2.root_id                                                              as id,
             fu2.record_id,
             ROW_NUMBER() OVER (
                 PARTITION BY fu2.record_id ORDER BY fu2.redcap_repeat_instance DESC) as visit_id,
             fu2.wra_fu_visit_date                                                    as visit_date,
             fu2.fu_hhe_hh_member_id                                                  as member_id,
             fu2.redcap_repeat_instance                                               as attempt_number,
             fu2.redcap_event_name                                                    as visit_name,
             fu2.wra_fu_interviewer_obsloc                                            as ra,
             fu2.wra_fu_wra_ptid                                                      as wra_ptid,
             fu2.wra_fu_pp_avail                                                      as is_wra_available,
             fu2.wra_fu_pp_avail_label                                                as is_wra_available_label,
             fu2.wra_fu_is_wra_avail_other                                            as is_wra_available_oth_label
      FROM wra_follow_up_visit_repeating_instruments fu2) v2
