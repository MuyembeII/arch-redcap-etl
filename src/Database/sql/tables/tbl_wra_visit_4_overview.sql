...
CREATE INDEX visit_4_wra_ptid_idx ON arch_etl_db.crt_wra_visit_4_overview (wra_ptid);
...
FROM (SELECT fu4.root_id                                                              as id,
             fu4.record_id,
             ROW_NUMBER() OVER (
                 PARTITION BY fu4.record_id ORDER BY fu4.redcap_repeat_instance DESC) as visit_id,
             fu4.wra_fu_visit_date_f3                                                 as visit_date,
             fu4.hhe_hh_member_id_f3                                                  as member_id,
             fu4.redcap_repeat_instance                                               as attempt_number,
             fu4.redcap_event_name                                                    as visit_name,
             fu4.wra_fu_interviewer_obsloc_f3                                         as ra,
             fu4.wra_fu_wra_ptid_f3                                                   as wra_ptid,
             fu4.hh_scrn_num_obsloc_f3                                                as screening_id,
             fu4.wra_fu_pp_avail_f3                                                   as is_wra_available,
             fu4.wra_fu_pp_avail_f3_label                                             as is_wra_available_label,
             fu4.wra_fu_is_wra_avail_other_f3                                         as is_wra_available_oth_label
      FROM wra_follow_up_visit_3_repeating_instruments fu4) v2
