/**
 * Returns WRA Follow-Up 3 estimated gestational age in Week(s) and Day(s).
...
BEGIN
    ...
    SELECT COALESCE(ps_v4.ps_fu_visit_date_f3, v4.visit_date),
           IF(ps_v4.fu_lmp_start_scorres_f3 = 1, ps_v4.fu_lmp_scdat_f3, getEstimated_LMP_V1(p_record_id))
