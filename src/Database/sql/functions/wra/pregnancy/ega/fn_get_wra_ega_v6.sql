/**
 * Returns WRA Follow-Up 5 estimated gestational age in Week(s) and Day(s).

 * By using the LMP date and the current visit date to find the difference from
 * the the first day of the LMP, the result is casted into weeks and then the
 * remainder of days appended is appended after the week expression i,.e 29.4 is
 * denoted as 29 weeks and 4 days. Note that the days expression range is 1 to 7.
 *
