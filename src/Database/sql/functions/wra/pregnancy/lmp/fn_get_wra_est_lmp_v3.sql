 ...
 * ;) :) how bou' dee?!!!
  |-------------------------------------------------------------------------------------------|
 * I want to give you WRA-Follow-Up-2 Visit estimated last menstrual period(LMP) visit date...
 ...
 */
DROP FUNCTION IF EXISTS `getEstimated_LMP_V3`;
DELIMITER $$
CREATE FUNCTION arch_etl_db.getEstimated_LMP_V3(p_record_id BIGINT)
    RETURNS DATE
    READS SQL DATA
    NOT DETERMINISTIC
BEGIN
    ...
    SELECT COALESCE(ps_v3.ps_fu_visit_date_f2, v2.visit_date),
           ps_v3.fu_lmp_start_weeks_f2,
           ps_v3.fu_lmp_start_months_f2,
           ps_v3.fu_lmp_start_years_f2,
           ps_v3.fu_lmp_cat_scorres_f2
    ...
    FROM wrafu_pregnancy_surveillance_2 ps_v3
             JOIN arch_etl_db.crt_wra_visit_3_overview v2 on ps_v3.record_id = v2.record_id
