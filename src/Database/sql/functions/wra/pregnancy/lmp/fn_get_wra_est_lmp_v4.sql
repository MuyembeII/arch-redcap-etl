 ...
 * ;) :) how bou' dee?!!!
  |-------------------------------------------------------------------------------------------|
 * I want to give you WRA-Follow-Up-3 Visit estimated last menstrual period(LMP) visit date...
 ...
 */
DROP FUNCTION IF EXISTS `getEstimated_LMP_V4`;
DELIMITER $$
CREATE FUNCTION arch_etl_db.getEstimated_LMP_V4(p_record_id BIGINT)
    RETURNS DATE
    READS SQL DATA
    NOT DETERMINISTIC
BEGIN
    ...
    SELECT COALESCE(ps_v4.ps_fu_visit_date_f3, v2.visit_date),
           ps_v4.fu_lmp_start_weeks_f3,
           ps_v4.fu_lmp_start_months_f3,
           ps_v4.fu_lmp_start_years_f3,
           ps_v4.fu_lmp_cat_scorres_f3
    ...
    FROM wrafu_pregnancy_surveillance_3 ps_v4
             JOIN arch_etl_db.crt_wra_visit_4_overview v2 on ps_v4.record_id = v2.record_id
