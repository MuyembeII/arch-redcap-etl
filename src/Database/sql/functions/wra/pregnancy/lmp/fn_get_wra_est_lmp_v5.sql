 ...
 * ;) :) how bou' dee?!!!
  |-------------------------------------------------------------------------------------------|
 * I want to give you WRA-Follow-Up-4 Visit estimated last menstrual period(LMP) visit date...
 ...
 */
DROP FUNCTION IF EXISTS `getEstimated_LMP_V5`;
DELIMITER $$
CREATE FUNCTION arch_etl_db.getEstimated_LMP_V5(p_record_id BIGINT)
    RETURNS DATE
    READS SQL DATA
    NOT DETERMINISTIC
BEGIN
    ...
    SELECT COALESCE(ps_v5.ps_fu_visit_date_f4, v2.visit_date),
           ps_v5.fu_lmp_start_weeks_f4,
           ps_v5.fu_lmp_start_months_f4,
           ps_v5.fu_lmp_start_years_f4,
           ps_v5.fu_lmp_cat_scorres_f4
    ...
    FROM wrafu_pregnancy_surveillance_4 ps_v5
             JOIN arch_etl_db.crt_wra_visit_5_overview v2 on ps_v5.record_id = v2.record_id
