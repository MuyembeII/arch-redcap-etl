...
BEGIN
    ...
    SELECT COALESCE(pos_v5.ps_fu_visit_date_f4, v5.visit_date),
           pos_v5.fu_lmp_scdat_f4,
           CASE pos_v5.fu_lmp_cat_scorres_f4
               WHEN 0 THEN pos_v5.fu_lmp_start_weeks_f4
               WHEN 1 THEN pos_v5.fu_lmp_start_months_f4
               WHEN 2 THEN pos_v5.fu_lmp_start_years_f4 END,
           CASE pos_v5.fu_lmp_cat_scorres_f4
               WHEN 0 THEN 'week(s)'
               WHEN 1 THEN 'month(s)'
