/**
 * Returns WRA FU-2 estimated date of delivery(EDD) using Naegele’s rule.
...
BEGIN
    ...
    -- WRA FU-2 Pregnancy Surveillance
    SELECT IF(pos_v3.fu_lmp_start_scorres_f2 = 1, pos_v3.fu_lmp_scdat_f2, getEstimated_LMP_V1(p_record_id))
    INTO v_fu_lmp_date
