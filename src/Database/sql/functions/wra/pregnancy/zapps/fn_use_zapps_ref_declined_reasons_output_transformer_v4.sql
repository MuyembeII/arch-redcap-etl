...
BEGIN
    ...
    SELECT IF(pa_v4.fu_ref_res_decline_f3___1 = 1, pa_v4.fu_ref_res_decline_f3___1_label, ''),
           IF(pa_v4.fu_ref_res_decline_f3___2 = 1, pa_v4.fu_ref_res_decline_f3___2_label, ''),
           IF(pa_v4.fu_ref_res_decline_f3___3 = 1, pa_v4.fu_ref_res_decline_f3___3_label, ''),
           IF(pa_v4.fu_ref_res_decline_f3___4 = 1, pa_v4.fu_ref_res_decline_f3___4_label, ''),
           IF(pa_v4.fu_ref_res_decline_f3___5 = 1, pa_v4.fu_ref_res_decline_f3___5_label, ''),
    ...
    SET @v_ref_declined_reasons_v4 = CONCAT_WS(',',
                                               ...
                                               v_zapps_ref_declined_reasons_5,
                                               v_zapps_ref_declined_reasons_6);
    SET @v_ref_declined_reasons_v4 = TRIM(',' FROM @v_ref_declined_reasons_v4);
    SET v_zapps_ref_declined_reasons_v4 = REGEXP_REPLACE(@v_ref_declined_reasons_v4, ',', CONCAT(',', SPACE(1)));
