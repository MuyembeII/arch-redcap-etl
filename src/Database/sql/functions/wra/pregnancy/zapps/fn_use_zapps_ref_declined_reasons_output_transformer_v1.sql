...
CREATE FUNCTION use_ZAPPS_RefDeclinedReasonsTransformer_V1(p_record_id BIGINT)
    ...
    DETERMINISTIC
BEGIN
    DECLARE v_zapps_ref_declined_reasons_v1 TEXT;
    ...
    SELECT IF(pa_v1.ref_res_decline___1 = 1, CONCAT_WS(',', pa_v1.ref_res_decline___1_label, ' '), ''),
           IF(pa_v1.ref_res_decline___2 = 1, CONCAT_WS(',', pa_v1.ref_res_decline___2_label, ' '), ''),
           IF(pa_v1.ref_res_decline___3 = 1, CONCAT_WS(',', pa_v1.ref_res_decline___3_label, ' '), ''),
           IF(pa_v1.ref_res_decline___4 = 1, CONCAT_WS(',', pa_v1.ref_res_decline___4_label, ' '), ''),
           IF(pa_v1.ref_res_decline___5 = 1, CONCAT_WS(',', pa_v1.ref_res_decline___5_label, ' '), ''),
    ...
    SET v_zapps_ref_declined_reasons_v1 = CONCAT(
            ...
            v_zapps_ref_declined_reasons_5,
            v_zapps_ref_declined_reasons_6);
    SET v_zapps_ref_declined_reasons_v1 = TRIM(',' FROM v_zapps_ref_declined_reasons_v1);
