...
BEGIN
    ...
    SELECT IF(pa_v3.fu_ref_res_decline_f2___1 = 1, pa_v3.fu_ref_res_decline_f2___1_label, ''),
           IF(pa_v3.fu_ref_res_decline_f2___2 = 1, pa_v3.fu_ref_res_decline_f2___2_label, ''),
           IF(pa_v3.fu_ref_res_decline_f2___3 = 1, pa_v3.fu_ref_res_decline_f2___3_label, ''),
           IF(pa_v3.fu_ref_res_decline_f2___4 = 1, pa_v3.fu_ref_res_decline_f2___4_label, ''),
           IF(pa_v3.fu_ref_res_decline_f2___5 = 1, pa_v3.fu_ref_res_decline_f2___5_label, ''),
    ...
    SET @v_ref_declined_reasons_v3 = CONCAT_WS(',',
                                               ...
                                               v_zapps_ref_declined_reasons_5,
                                               v_zapps_ref_declined_reasons_6);
    SET @v_ref_declined_reasons_v3 = TRIM(',' FROM @v_ref_declined_reasons_v3);
    SET v_zapps_ref_declined_reasons_v3 = REGEXP_REPLACE(@v_ref_declined_reasons_v3, ',', CONCAT(',', SPACE(1)));
