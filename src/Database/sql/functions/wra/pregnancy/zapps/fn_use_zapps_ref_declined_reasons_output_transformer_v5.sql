...
BEGIN
    ...
    SELECT IF(pa_v5.fu_ref_res_decline_f4___1 = 1, CONCAT_WS(',', pa_v5.fu_ref_res_decline_f4___1_label, ' '), ''),
           IF(pa_v5.fu_ref_res_decline_f4___2 = 1, CONCAT_WS(',', pa_v5.fu_ref_res_decline_f4___2_label, ' '), ''),
           IF(pa_v5.fu_ref_res_decline_f4___3 = 1, CONCAT_WS(',', pa_v5.fu_ref_res_decline_f4___3_label, ' '), ''),
           IF(pa_v5.fu_ref_res_decline_f4___4 = 1, CONCAT_WS(',', pa_v5.fu_ref_res_decline_f4___4_label, ' '), ''),
           IF(pa_v5.fu_ref_res_decline_f4___5 = 1, CONCAT_WS(',', pa_v5.fu_ref_res_decline_f4___5_label, ' '), ''),
    ...
    SET v_zapps_ref_declined_reasons_v5 = CONCAT(
            ...
            v_zapps_ref_declined_reasons_5,
            v_zapps_ref_declined_reasons_6);
    SET v_zapps_ref_declined_reasons_v5 = TRIM(',' FROM v_zapps_ref_declined_reasons_v5);
