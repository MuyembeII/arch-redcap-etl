...
BEGIN
    ...
    SELECT IF(pa_v3.np_fu_drug_sutrt_f2___1 = 1, pa_v3.np_fu_drug_sutrt_f2___1_label, ''),
           IF(pa_v3.np_fu_drug_sutrt_f2___2 = 1, pa_v3.np_fu_drug_sutrt_f2___2_label, ''),
           IF(pa_v3.np_fu_drug_sutrt_f2___3 = 1, pa_v3.np_fu_drug_sutrt_f2___3_label, ''),
           IF(pa_v3.np_fu_drug_sutrt_f2___4 = 1, pa_v3.np_fu_drug_sutrt_f2___4_label, ''),
           IF(pa_v3.np_fu_drug_sutrt_f2___5 = 1, pa_v3.np_fu_drug_sutrt_f2___5_label, ''),
           IF(pa_v3.np_fu_drug_sutrt_f2___6 = 1, pa_v3.np_fu_drug_sutrt_f2___6_label, ''),
    ...
    SET @v_other_drugs_consumed_v3 = CONCAT_WS(
            ',',
            ...
            v_hb_other_drugs_consumed_6,
            v_hb_other_drugs_consumed_7);
    SET @v_other_drugs_consumed_v3 = TRIM(',' FROM @v_other_drugs_consumed_v3);
    SET v_hb_other_drugs_consumed_v3 = REGEXP_REPLACE(@v_other_drugs_consumed_v3, ',', CONCAT(',', SPACE(1)));
