...
BEGIN
    ...
    SELECT IF(pa_v3.fu_tob_oth_stutrt_f2___1 = 1, CONCAT_WS(',', pa_v3.fu_tob_oth_stutrt_f2___1_label, ' '), ''),
           IF(pa_v3.fu_tob_oth_stutrt_f2___2 = 1, CONCAT_WS(',', pa_v3.fu_tob_oth_stutrt_f2___2_label, ' '), ''),
           IF(pa_v3.fu_tob_oth_stutrt_f2___3 = 1, CONCAT_WS(',', pa_v3.fu_tob_oth_stutrt_f2___3_label, ' '), ''),
           IF(pa_v3.fu_tob_oth_stutrt_f2___4 = 1, CONCAT_WS(',', pa_v3.fu_tob_oth_stutrt_f2___4_label, ' '), ''),
           IF(pa_v3.fu_tob_oth_stutrt_f2___5 = 1, CONCAT_WS(',', pa_v3.fu_tob_oth_stutrt_f2___5_label, ' '), ''),
           IF(pa_v3.fu_tob_oth_stutrt_f2___6 = 1, CONCAT_WS(',', pa_v3.fu_tob_oth_stutrt_f2___6_label, ' '), ''),
    ...
    SET v_hb_other_tobacco_consumed_v3 = CONCAT(
            ...
            v_hb_other_tobacco_consumed_6,
            v_hb_other_tobacco_consumed_7);
    SET v_hb_other_tobacco_consumed_v3 = TRIM(',' FROM TRIM(v_hb_other_tobacco_consumed_v3));
