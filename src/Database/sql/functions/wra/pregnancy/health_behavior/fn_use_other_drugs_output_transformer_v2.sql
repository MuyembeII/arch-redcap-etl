...
BEGIN
    ...
    SELECT IF(pa_v2.np_fu_drug_sutrt___1 = 1, pa_v2.np_fu_drug_sutrt___1_label, ''),
           IF(pa_v2.np_fu_drug_sutrt___2 = 1, pa_v2.np_fu_drug_sutrt___2_label, ''),
           IF(pa_v2.np_fu_drug_sutrt___3 = 1, pa_v2.np_fu_drug_sutrt___3_label, ''),
           IF(pa_v2.np_fu_drug_sutrt___4 = 1, pa_v2.np_fu_drug_sutrt___4_label, ''),
           IF(pa_v2.np_fu_drug_sutrt___5 = 1, pa_v2.np_fu_drug_sutrt___5_label, ''),
           IF(pa_v2.np_fu_drug_sutrt___6 = 1, pa_v2.np_fu_drug_sutrt___6_label, ''),
    ...
    SET @v_other_drugs_consumed_v2 = CONCAT_WS(
            ',',
            ...
            v_hb_other_drugs_consumed_6,
            v_hb_other_drugs_consumed_7);
    SET @v_other_drugs_consumed_v2 = TRIM(',' FROM @v_other_drugs_consumed_v2);
    SET v_hb_other_drugs_consumed_v2 = REGEXP_REPLACE(@v_other_drugs_consumed_v2, ',', CONCAT(',', SPACE(1)));
