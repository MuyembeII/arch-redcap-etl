...
BEGIN
    ...
    SELECT IF(pa_v5.fu_tob_oth_stutrt_f4___1 = 1, CONCAT_WS(',', pa_v5.fu_tob_oth_stutrt_f4___1_label, ' '), ''),
           IF(pa_v5.fu_tob_oth_stutrt_f4___2 = 1, CONCAT_WS(',', pa_v5.fu_tob_oth_stutrt_f4___2_label, ' '), ''),
           IF(pa_v5.fu_tob_oth_stutrt_f4___3 = 1, CONCAT_WS(',', pa_v5.fu_tob_oth_stutrt_f4___3_label, ' '), ''),
           IF(pa_v5.fu_tob_oth_stutrt_f4___4 = 1, CONCAT_WS(',', pa_v5.fu_tob_oth_stutrt_f4___4_label, ' '), ''),
           IF(pa_v5.fu_tob_oth_stutrt_f4___5 = 1, CONCAT_WS(',', pa_v5.fu_tob_oth_stutrt_f4___5_label, ' '), ''),
           IF(pa_v5.fu_tob_oth_stutrt_f4___6 = 1, CONCAT_WS(',', pa_v5.fu_tob_oth_stutrt_f4___6_label, ' '), ''),
    ...
    SET v_hb_other_tobacco_consumed_v5 = CONCAT(
            ...
            v_hb_other_tobacco_consumed_6,
            v_hb_other_tobacco_consumed_7);
    SET v_hb_other_tobacco_consumed_v5 = TRIM(',' FROM TRIM(v_hb_other_tobacco_consumed_v5));
