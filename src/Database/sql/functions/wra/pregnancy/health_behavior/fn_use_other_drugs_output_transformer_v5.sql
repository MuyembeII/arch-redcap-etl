...
BEGIN
    ...
    SET @v_other_drugs_consumed_v5 = CONCAT_WS(
            ',',
            ...
            v_hb_other_drugs_consumed_6,
            v_hb_other_drugs_consumed_7);
    SET @v_other_drugs_consumed_v5 = TRIM(',' FROM @v_other_drugs_consumed_v5);
    SET v_hb_other_drugs_consumed_v5 = REGEXP_REPLACE(@v_other_drugs_consumed_v5, ',', CONCAT(',', SPACE(1)));
