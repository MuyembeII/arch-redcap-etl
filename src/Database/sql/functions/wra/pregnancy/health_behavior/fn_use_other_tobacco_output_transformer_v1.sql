...
BEGIN
    ...
    SELECT IF(pa_v1.tob_oth_sutrt___1 = 1, pa_v1.tob_oth_sutrt___1_label, ''),
           IF(pa_v1.tob_oth_sutrt___2 = 1, pa_v1.tob_oth_sutrt___2_label, ''),
           IF(pa_v1.tob_oth_sutrt___3 = 1, pa_v1.tob_oth_sutrt___3_label, ''),
           IF(pa_v1.tob_oth_sutrt___4 = 1, pa_v1.tob_oth_sutrt___4_label, ''),
           IF(pa_v1.tob_oth_sutrt___5 = 1, pa_v1.tob_oth_sutrt___5_label, ''),
           IF(pa_v1.tob_oth_sutrt___6 = 1, pa_v1.tob_oth_sutrt___6_label, ''),
    ...
    SET @v_other_tobacco_consumed_v1 = CONCAT_WS(
            ',',
            ...
            v_hb_other_tobacco_consumed_6,
            v_hb_other_tobacco_consumed_7);
    SET @v_other_tobacco_consumed_v1 = TRIM(',' FROM TRIM(@v_other_tobacco_consumed_v1));
    SET v_hb_other_tobacco_consumed_v1 = REGEXP_REPLACE(@v_other_tobacco_consumed_v1, ',', CONCAT(',', SPACE(1)));
