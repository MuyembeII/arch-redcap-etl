...
BEGIN
    ...
    WHERE v4.visit_outcome = 'Completed'
      AND v4.record_id IN (SELECT a.record_id FROM wrafu_pregnancy_assessments_3 a WHERE a.pa_fu_visit_date_f3 IS NOT NULL)
    ...
    WHERE poa_v4.pa_fu_visit_date_f3 IS NOT NULL;
    COMMIT;
