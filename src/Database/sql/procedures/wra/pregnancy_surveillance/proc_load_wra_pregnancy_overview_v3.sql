...
BEGIN
    ...
    WHERE v3.visit_outcome = 'Completed'
      AND v3.record_id IN
          (SELECT ps.record_id FROM wrafu_pregnancy_surveillance_2 ps WHERE ps.fu_lmp_reg_scorres_f2 IS NOT NULL)
    ...
    SET v3.menstruation_outcome             = IF(ps_v3.fu_lmp_reg_scorres_f2 = 1, 'Menstruating',
                                                 IF(ps_v3.fu_lmp_reg_scorres_f2 = 0, 'Not Menstruating',
                                                    ps_v3.fu_lmp_reg_scorres_f2)),
        ...
        v3.lmp_date                         = ps_v3.fu_lmp_scdat_f2,
        v3.estimated_lmp                    = CASE ps_v3.fu_lmp_cat_scorres_f2
        ...
        v3.estimated_lmp_flag               = CASE ps_v3.fu_lmp_cat_scorres_f2
                                                  WHEN 0 THEN 'week(s)'
                                                  WHEN 1 THEN 'month(s)'
        ...
        v3.pregnant_since_last_visit        = IF(ps_v3.ps_preg_last_visit_f2 = 1, 'Yes',
                                                 IF(ps_v3.ps_preg_last_visit_f2 = 0, 'No',
                                                    ps_v3.ps_preg_last_visit_f2)),
