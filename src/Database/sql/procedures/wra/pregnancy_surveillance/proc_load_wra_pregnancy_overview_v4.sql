...
BEGIN
    ...
    WHERE v4.visit_outcome = 'Completed'
      AND v4.record_id IN
          (SELECT ps.record_id FROM wrafu_pregnancy_surveillance_3 ps WHERE ps.fu_lmp_reg_scorres_f3 IS NOT NULL)
    ...
    SET v4.menstruation_outcome             = IF(ps_v4.fu_lmp_reg_scorres_f3 = 1, 'Menstruating',
        ...
        v4.lmp_date                         = ps_v4.fu_lmp_scdat_f3,
        v4.estimated_lmp                    = CASE ps_v4.fu_lmp_cat_scorres_f3
        ...
        v4.estimated_lmp_flag               = CASE ps_v4.fu_lmp_cat_scorres_f3
                                                  WHEN 0 THEN 'week(s)'
                                                  WHEN 1 THEN 'month(s)'
