...
BEGIN
    ...
    WHERE v3.record_id IN (SELECT DISTINCT a.record_id
                           ...
                           WHERE (a.np_fu_zapps_scorres_f2 IS NOT NULL OR a.np_fu_anc_mhyn_f2 IS NOT NULL) AND a.fu_name_veri_f2 IS NOT NULL)
    ...
    SET v3.visit_date                                = COALESCE(pa.pa_fu_visit_date_f2, v3.visit_date),
        ...
        v3.anc_attendance_plan                       = np_fu_anc_plan_obsloc_f2_label,
        ...
        v3.place_for_birth_planner                   = (
            CASE
                ...
                WHEN pa.fu_birth_plan_fac_obsloc_f2 = 88 THEN UCASE(useAutoTrimmer(pa.fu_del_decide_spfy_scorres_f2))
        ...
        v3.zapps_referral_outcome                 = IF(pa.fu_ref_likely_scorres_f2 = 1, 'Accepted',
                                                          IF(pa.fu_ref_likely_scorres_f2 = 0, 'Declined', pa.fu_ref_likely_scorres_f2)),
    ...
    WHERE v3.record_id = pa.record_id
      ...
      AND poc.visit_number = v3.visit_number AND poc.upt_result = 'Positive';
    COMMIT;
