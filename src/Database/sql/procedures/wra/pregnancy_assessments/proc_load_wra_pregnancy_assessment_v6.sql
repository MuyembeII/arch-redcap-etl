...
BEGIN
    ...
    WHERE v6.record_id IN (SELECT DISTINCT a.record_id
                           ...
                           WHERE (a.np_fu_zapps_scorres_f5 IS NOT NULL OR a.np_fu_anc_mhyn_f5 IS NOT NULL) AND a.fu_name_veri_f5 IS NOT NULL)
    ...
    SET v6.visit_date                                = COALESCE(pa.pa_fu_visit_date_f5, v6.visit_date),
        ...
        v6.anc_attendance_plan                       = np_fu_anc_plan_obsloc_f5_label,
        ...
        v6.place_for_birth_planner                   = (
            CASE
                ...
                WHEN pa.fu_birth_plan_fac_obsloc_f5 = 88 THEN UCASE(useAutoTrimmer(pa.fu_del_decide_spfy_scorres_f5))
        ...
        v6.zapps_referral_outcome                 = IF(pa.fu_ref_likely_scorres_f5 = 1, 'Accepted',
                                                          IF(pa.fu_ref_likely_scorres_f5 = 0, 'Declined', pa.fu_ref_likely_scorres_f5)),
    ...
    WHERE v6.record_id = pa.record_id
      ...
      AND poc.visit_number = v6.visit_number AND poc.upt_result = 'Positive';
    COMMIT;
